...
;
          ...
          <div className="card-personal-first">
            <div className="row d-flex justify-content-between">
              <div className="input-container col-sm-6 col-12 mb-4 mb-sm-4 ">
                <input
                  ...
                  id="personal-trainer"
                  name="Çalışılan Hoca"
                  placeholder="Çalışılan Hoca ( Yok ise boş bırakınız )"
                  value={trainerName}
              ...
              <div className="input-container col-sm-6 col-12 mb-4 mb-sm-4 ">
                <textarea
                  ...
                  id="sport-history"
                  placeholder="Spor Geçmişiniz ( Yok ise boş bırakınız )"
                  cols="30"
                  rows="5"
                  value={sportHistory}
              ...
              <div className="input-container col-sm-6 col-12 mb-4 mb-sm-4 ">
                <textarea
                  ...
                  name="Özel not"
                  id="special-note"
                  placeholder="Bunların Dışında Bilmemi İstediğiniz Bir Şey Var İse Not Ediniz.Yok ise boş bırakınız"
                  cols="30"
                  rows="5"
                  value={specialNote}
            ...
            >
              {!alertValidation ? "İlerle" : "Tüm Alanları Cevaplayınız"}
            </button>
          </div>
        </div>
      )}
